...
<div class="row">
    <div class="col-2 justify-content-center mb-5">
        <div class="row">
            <div class="col-12 mb-1">
                <?= anchor('stanice/' . $zeme->id, '<button type="button" class="btn btn-sm btn-outline-dark mt-2">Zpět</button>') ?>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <?= anchor('/', '<button type="button" class="btn btn-sm btn-outline-warning mt-2">Zpět na úvodní stránku</button>') ?>
            </div>
        </div>
    </div>
</div>
